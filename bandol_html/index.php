...
<html lang="en">
  <head>
    ...
    <meta name="author" content="Ruz Estudio">    
  ...
  <body>
        ...
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
              <a class="logo" href="index.php">
            	...
            	<a class="navbar-brand navbar-logo navbar-logo-xs" href="index.php"></a>
              ...
              <ul class="nav navbar-nav navbar-right">								
								...
								<li class="nav-redes">
										<ul class="nav-redes-ul">
											<li><a href="https://www.instagram.com/explore/locations/534069746/" target="_blank" class="ic-redes ic-ig"></a></li>
											<li><a href="https://www.facebook.com/bandolbar.restaurante/" target="_blank" class="ic-redes ic-fb"></a></li>
											<li><a href="#mapa" class="ic-redes ic-mp toplink"></a></li>
					   			</ul>
					   		</li>
            	</ul>
	...
	<div class="container">	 
      ...
      <section id="contacto" class="contacto">
      	<div class="row">
              ...
              <br><br>
              <hr>
              <a href="https://api.whatsapp.com/send?phone=549113134010" target="_blank" class="btn btn-success">
                <img src="/img/whatsapp.png" alt="" > Contactar por Whatsapp
              </a>  
      				</div>
      			</div>
      		</div>
    ...
    <script>
      ...
      fbq('init', '169760277033180');
      fbq('track', 'PageView');
    </script>

    <noscript><img height="1" width="1" style="display:none"
      src="https://www.facebook.com/tr?id=169760277033180&ev=PageView&noscript=1"
    /></noscript>

    <!-- End Facebook Pixel Code -->

    <!-- Global site tag (gtag.js) - Google Analytics -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=UA-120299256-1"></script>
    <script>
      window.dataLayer = window.dataLayer || [];
      function gtag(){dataLayer.push(arguments);}
      gtag('js', new Date());
     
      gtag('config', 'UA-120299256-1');
    </script>
     
     
    <meta name="google-site-verification" content="sja-LTj0olnIqKsaeUivCRG8xg5rLPQNQGiYK6dMejY" />
    ...
    s1.async=true;
    s1.src='https://embed.tawk.to/5b15918710b99c7b36d49e70/default';
    s1.charset='UTF-8';
